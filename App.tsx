      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          <a href="https://aulakhelectronics.com/" className="flex-shrink-0 flex items-center group transition-all">
            <div className="w-10 h-10 bg-blue-600 rounded-lg flex items-center justify-center text-white mr-3 shadow-lg shadow-blue-500/30 group-hover:bg-blue-700 transition-colors">
        ...
        <div className="relative rounded-3xl overflow-hidden shadow-2xl h-96">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-gray-900/90 to-transparent flex flex-col justify-center px-12">
            ...
            <p className="text-gray-300 max-w-lg mb-8 text-lg">
              We handle the entire import processâ€”from sourcing the right machine in China to customs clearance and delivery in Gujranwala. You get world-class tech without the logistical headache.
            </p>
    ...
    return (
      <section id="contact" className="py-20 bg-gray-900 text-white flex items-center justify-center min-h-[600px]">
        <div className="text-center p-10 bg-white rounded-2xl text-gray-900 max-w-md mx-4">
          ...
          <p className="text-gray-600">Our engineering team will contact you at <b>{formData.email}</b> within 24 hours.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <input type="email" id="email" required value={formData.email} onChange={e => setFormData({ ...formData, email: e.target.value })} className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-blue-600 focus:border-transparent outline-none transition-all bg-gray-50" placeholder="info@example.com" />
                </div>
                <div>
    ...
    <footer className="bg-gray-950 text-white py-12 border-t border-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-gray-900 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-600 text-sm">Â© {new Date().getFullYear()} Aulakh Electronics. All rights reserved.</p>
